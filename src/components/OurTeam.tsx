...
const teamData: TeamSection[] = [
  ...
  },
  {
    ...
    members: [
      ...
      { name: "Doneshwaran", year: "III", photo: "/public/images/team/dhoneshwaran.jpg" },
  ...
  },
  {
    ...
    members: [
      ...
      { name: "Hariprasad", year: "II", photo: "/public/images/team/hariprasath.jpeg" },
      { name: "Aiswarya Lakshmi", year: "II", photo: "/public/images/team/aishwarya.jpg" },
  ...
  },
  {
    ...
    members: [
      ...
      { name: "Vishnupriya I", year: "III", photo: "/public/images/team/vishnupriya.jpg" },
  ...
  },
  {
    title: "Design Team",
    members: [
      { name: "Dharshini V", year: "II", photo: "/public/images/team/dharshini.jpg" },
      { name: "Jovitha Sheethal B", year: "II", photo: "/images/team/jovithasheetal.jpg" },
      { name: "Harini M", year: "II", photo: "/public/images/team/harini.png" },
      { name: "Gayathri Dheivy P B", year: "II", photo: "/images/team/gayathridheviey.jpg" },
      { name: "Indhumathy K", year: "II", photo: "/public/images/team/indumathi.jpg" },
    ],
  },
  {
    ...
    members: [
      ...
      { name: "Poojasri", year: "II", photo: "/public/images/team/poojasri.png" },
    ],
  },
  {
